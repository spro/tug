...
(function() {
  var argv, argv_hosts, argv_steps, async, coerceSshconfHost, connectToHost, executeSteps, fs, key_matched, line, makeStepScript, minimist, path, resolvePath, ssh, tugfile, tugfile_filename, tugfile_keys, tugfile_lines, tugfile_name, _i, _key, _len, _val,
  ...
  executeSteps = function(ssh_conn, steps) {};
  ...
  connectToHost = function(host_data) {
    ...
    return ssh_conn.on('ready', function() {
      return async.map(tugfile.steps, function(s, _cb) {
        var step_script;
